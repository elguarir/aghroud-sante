    ...
    return (
      <button
        ...
        className={cn(
          ...
          "dark:text-neutral-400 hover:dark:text-neutral-200",
          // border color
          "border-neutral-300 dark:border-neutral-700",
          // background color
          "hover:bg-neutral-50 active:bg-neutral-100",
          "hover:dark:bg-neutral-900 active:dark:bg-neutral-800",
          // disabled
          "disabled:pointer-events-none",
          "disabled:border-neutral-200 disabled:dark:border-neutral-800",
          "disabled:text-neutral-400 disabled:dark:text-neutral-600",
          focusRing,
        )}
        onClick={onClick}
        {...props}
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "size-9 rounded text-sm text-neutral-900 dark:text-neutral-50",
