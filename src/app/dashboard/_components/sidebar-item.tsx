...
export const SideBarItem = ({ icon, title, href = "" }: Props) => {
  ...
  return (
    <Link
      ...
      href={href}
      className={cn(
        "flex h-full w-full items-center gap-2.5 rounded-md px-3.5 py-2 text-medium font-medium text-default-600 transition-colors duration-200 hover:bg-default-200/30",
        isActive
