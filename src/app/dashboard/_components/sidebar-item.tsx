    ...
    return (
      <Link
        ...
        className={cn(
          ...
          isActive
            ? "border-default-600/10 bg-default text-default-foreground hover:bg-default/90"
              ...
              {item.items.map((i) => {
                ...
                return (
                  <Link
                    ...
                    href={i.href}
                    className={cn(
                      "flex h-full w-full items-center gap-2.5 rounded-md border border-transparent px-3.5 py-2 text-medium font-medium text-default-600 transition-colors duration-200 hover:bg-default-200/30 focus-visible:border focus-visible:border-primary focus-visible:outline-offset-0 focus-visible:outline-primary",
                      isActive
                        ? "border-default-600/10 bg-default text-default-foreground hover:bg-default/90"
                        : "hover:text-default-900",
                    )}
